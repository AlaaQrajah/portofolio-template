...
const RecentProjects = (props: Props) => {
  return (
    <div
      className="py-20 max-h-max w-full flex flex-col gap-6 sm:max-w-[95vw] max-w-7xl"
      id="projects"
    >
      <h1 className="heading text-teal-800">
        A small selection <span className="">recent projects</span>
      </h1>
      <div
        className="flex flex-wrap flex-rowh -max justify-center items-center
