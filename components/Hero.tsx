        ...
        <div>
          ...
          <div className="flex justify-center relative">
            ...
            /> */}
              ...
              <p className="text-center text-stone-700 font-bold md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
                professional developer who designs scalable and efficient code I
              </p>
              <h2
                className="text-xs text-center text-stone-700 font-bold max-w-92 
